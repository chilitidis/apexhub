/**
 * Smoke test: feed every generated Phase 1 per-month workbook into the
 * production importExcel parser to confirm they are accepted.
 */
...
const DIR = '/home/ubuntu/journal_split_p1/per_month';

describe('Phase 1 100K month workbooks', () => {
