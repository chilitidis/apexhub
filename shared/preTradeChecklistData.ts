// preTradeChecklistData.ts
// ----------------------------------------------------------------------------
// Shared, pure data for the Pre-Trade Checklist (no browser APIs here so it can
// be imported by BOTH the client UI and the server-side Trading Coach prompt).
//
// 20 questions across 5 categories. Keep this in sync with the UI gate.
// ----------------------------------------------------------------------------
